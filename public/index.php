                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <!-- Eliminar alumnos  -->
                            <form action="borrar.php" method="POST" class="inline">
                                ...
                                <button type="submit" onclick="cambiar(event, <?= hh($fila['id']) ?>)" data-modal-toggle="popup-modal" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                    Borrar
                                </button>
                            </form>
                        </td>
