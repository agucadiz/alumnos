...
<body>
    ...
    if (isset($login, $password, $password_repeat)) {
        ...
        //Se crea un array de arrays porque ya no se debe machacar los alerts, debido a que se puede dar más de uno.
        ...
        if (preg_match('/[a-z]/', $password) !== 1) {
            $error['password'][] = 'Debe contener almenos una minúscula.';
        }

        if (preg_match('/[A-Z]/', $password) !== 1) {
            $error['password'][] = 'Debe contener almenos una mayúscula.';
        }

        if (preg_match('/[1-9]/', $password) !== 1) {
            $error['password'][] = 'Debe contener almenos un dígito.';
        }
        ...
        //Mostrar mensajes de error correspondientes a lo que le falta.
        $vacio = true;
